...
func TestMigrate_AddsColumnsOnUpgrade_Values(t *testing.T) {
	...
	rows, err := s.DB().Query(`PRAGMA table_info("values")`)
	if err != nil {
...
func TestMigrate_AddsColumnsOnUpgrade_CampaignsSend(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("campaigns_send")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_Points(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("points")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_Fork(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("fork")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_PriceLists(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("price_lists")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_Stock(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("stock")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_ReviewRequestsSend(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("review_requests_send")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_SiteSpecs(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("site_specs")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
...
func TestMigrate_AddsColumnsOnUpgrade_VatRates(t *testing.T) {
	...
	// The migration must have added every generated column.
	rows, err := s.DB().Query(`PRAGMA table_info("vat_rates")`)
	if err != nil {
		t.Fatalf("table_info: %v", err)
	}
	defer rows.Close()
