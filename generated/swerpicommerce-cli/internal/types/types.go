...
type CategoryInput struct {
	...
	Markups                  string          `json:"markups"`
	MetaTitle                string          `json:"meta_title"`
	MetodiPagamentoEsclusi   json.RawMessage `json:"metodi_pagamento_esclusi"`
	Nome                     string          `json:"nome"`
...
type ProductInput struct {
	...
	Sku                          string          `json:"sku"`
	Slug                         string          `json:"slug"`
	SpedizioneGratuita           bool            `json:"spedizione_gratuita"`
	SpedizioneGratuitaCumulativa bool            `json:"spedizione_gratuita_cumulativa"`
	Stato                        int             `json:"stato"`
	TipoProdotto                 string          `json:"tipo_prodotto"`
	Tipologia                    string          `json:"tipologia"`
	Um                           string          `json:"um"`
...
type SiteCacheCacheConfigUpdateResponse struct {
	Data json.RawMessage `json:"data"`
}

type SiteCacheCacheFlushResponse struct {
	Data json.RawMessage `json:"data"`
}

type SiteCacheCacheGetResponse struct {
	Data json.RawMessage `json:"data"`
}
