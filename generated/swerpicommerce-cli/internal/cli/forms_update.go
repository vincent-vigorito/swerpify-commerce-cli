...
func newFormsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyIubendaCampoEmail, "iubenda-campo-email", "", "Iubenda campo email")
	cmd.Flags().StringVar(&bodyIubendaCampoNome, "iubenda-campo-nome", "", "Iubenda campo nome")
