...
func newDesignTemplatesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "templates-list",
		Short:       "Elenca i template `.html` delle aree `partials` (`templates/frontend/partials/`) e `pagine_sistema`...",
	...
	cmd.Flags().StringVar(&flagArea, "area", "", "Filtra per area (one of: partials, pagine_sistema)")
