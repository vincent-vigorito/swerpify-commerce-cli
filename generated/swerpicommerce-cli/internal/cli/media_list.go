...
func newMediaListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "File immagine delle cartelle gestite (foto prodotto, immagini categorie prodotto, articoli blog, categorie blog), i...",
	...
	cmd.Flags().StringVar(&flagFolder, "folder", "", "Limita l'elenco a una cartella (one of: product_images, cat_images, blog, blog_cat_images)")
