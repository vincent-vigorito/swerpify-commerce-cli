...
func newForkLogCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "log",
		Short:       "Commit del branch corrente, dal piu' recente.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			}, map[string][]string{"path": {"path"}, "limit": {"limit"}, "offset": {"offset"}}, "offset", "offset"), nil, flagAll, "offset", "offset", "limit", 30, "", "", "data", cmd.ErrOrStderr())
			if err != nil {
