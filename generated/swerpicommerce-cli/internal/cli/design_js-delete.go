...
func newDesignJsDeleteCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "js-delete <filename>",
		Short:       "Elimina un file JS per-pagina",
		Annotations: map[string]string{"pp:endpoint": "design.js-delete", "pp:method": "DELETE", "pp:path": "/design/js/{filename}"},
