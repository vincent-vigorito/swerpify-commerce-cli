...
func newArticlesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Se `slug` manca viene generato dal titolo (univoco per lingua).",
		Annotations: map[string]string{"pp:endpoint": "articles.create", "pp:method": "POST", "pp:path": "/articles", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("contenuto") && bodyContenuto == "" && !flags.dryRun {
