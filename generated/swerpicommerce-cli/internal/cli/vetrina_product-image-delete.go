...
func newVetrinaProductImageDeleteCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "product-image-delete <id> <image_id>",
		Short:       "Rimuove solo il collegamento; il file resta in libreria (`DELETE /media` per eliminarlo).",
		Annotations: map[string]string{"pp:endpoint": "vetrina.product-image-delete", "pp:method": "DELETE", "pp:path": "/vetrina/products/{id}/images/{image_id}"},
