...
func newVetrinaAttributeCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "vetrina.attribute-create", "pp:method": "POST", "pp:path": "/vetrina/attributes", "pp:requires-input": "true"},
	...
	cmd.Flags().StringVar(&bodyTipo, "tipo", "testo", "testo = pillole con il valore; colore = valore usato come colore CSS (es.")
