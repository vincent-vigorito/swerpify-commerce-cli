...
func newSiteSpecsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Aliases:     []string{"list"},
		Short:       "Legge `site-specs.json` dalla root del fork.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "site-specs", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
