...
func newDiscountCodesUpdateCmd(flags *rootFlags) *cobra.Command {
	var bodyAttivo int
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"pp:endpoint": "discount-codes.update", "pp:method": "PUT", "pp:path": "/discount-codes/{id}"},
