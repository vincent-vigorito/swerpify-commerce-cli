...
but do not stop the import.`,
  ...
  swerpicommerce-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  swerpicommerce-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | swerpicommerce-pp-cli import <resource> --input -`,
