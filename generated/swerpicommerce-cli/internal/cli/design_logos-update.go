...
func newDesignLogosUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "logos-update",
		Short:       "Stessa operazione del pannello Grafica -> Loghi.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = bodyMap
				if cmd.Flags().Changed("favicon") || bodyFavicon != "" {
					bodyMap["favicon"] = bodyFavicon
				}
				if cmd.Flags().Changed("logo-black") || bodyLogoBlack != "" {
					bodyMap["logo_black"] = bodyLogoBlack
				}
				if cmd.Flags().Changed("logo-email") || bodyLogoEmail != "" {
					bodyMap["logo_email"] = bodyLogoEmail
				}
				if cmd.Flags().Changed("logo-is-trasparente") {
					bodyMap["logo_is_trasparente"] = bodyLogoIsTrasparente
				}
				if cmd.Flags().Changed("logo-mobile-black") || bodyLogoMobileBlack != "" {
					bodyMap["logo_mobile_black"] = bodyLogoMobileBlack
				}
				if cmd.Flags().Changed("logo-mobile-is-trasparente") {
					bodyMap["logo_mobile_is_trasparente"] = bodyLogoMobileIsTrasparente
				}
				if cmd.Flags().Changed("logo-mobile-white") || bodyLogoMobileWhite != "" {
					bodyMap["logo_mobile_white"] = bodyLogoMobileWhite
				}
				if cmd.Flags().Changed("logo-white") || bodyLogoWhite != "" {
					bodyMap["logo_white"] = bodyLogoWhite
				}
			}
