...
native streaming instead of polling.`,
  ...
  swerpicommerce-pp-cli tail --interval 10s

  # Tail a specific resource
  swerpicommerce-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  swerpicommerce-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
