...
func newProductsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get <id>",
		Short:       "Oltre ai campi del prodotto restituisce `tab_extra`: i tab aggiuntivi della scheda (risorsa `/extra-tabs`)",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagIncludeVariants != false {
				params["include_variants"] = formatCLIParamValue(flagIncludeVariants)
			}
