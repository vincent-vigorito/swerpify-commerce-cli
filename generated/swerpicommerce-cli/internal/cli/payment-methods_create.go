...
func newPaymentMethodsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "`attivo` e' false se non indicato: il metodo non compare al checkout finche' non viene attivato. Se `ordinamento` e'...",
		Example:     "  swerpicommerce-pp-cli payment-methods create --tipo example-value",
		Annotations: map[string]string{"pp:endpoint": "payment-methods.create", "pp:method": "POST", "pp:path": "/payment-methods"},
