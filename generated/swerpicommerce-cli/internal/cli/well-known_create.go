...
func newWellKnownCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Il file e' servito subito su `/.well-known/<nome>`.",
		Annotations: map[string]string{"pp:endpoint": "well-known.create", "pp:method": "POST", "pp:path": "/well-known", "pp:requires-input": "true"},
