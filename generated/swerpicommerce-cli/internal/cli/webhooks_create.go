...
func newWebhooksCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "`secret` è opzionale: se omesso ne viene generato uno e restituito nella risposta (resta comunque leggibile dalle...",
		Example:     "  swerpicommerce-pp-cli webhooks create --endpoint example-value",
	...
	cmd.Flags().StringVar(&bodyEndpoint, "endpoint", "", "URL a cui inviare le POST")
	cmd.Flags().StringVar(&bodyEvents, "events", "", "Events")
	cmd.Flags().StringVar(&bodyNome, "nome", "", "Nome")
	cmd.Flags().StringVar(&bodySecret, "secret", "", "Se omesso ne viene generato uno")
