...
func newProductsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				if bodyShowInHome != false {
					body["show_in_home"] = bodyShowInHome
				}
				if bodySku != "" {
					body["sku"] = bodySku
				}
	...
	cmd.Flags().StringVar(&bodyLang, "lang", "", "Codice lingua del prodotto (es. it, en; default = lingua predefinita del sito). Ogni traduzione è un prodotto...")
