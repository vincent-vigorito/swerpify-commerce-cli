...
func newProductsImagesProductUploadCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Due modalità alternative: contenuto base64 nel body JSON (nessun limite di dimensione applicativo",
		Annotations: map[string]string{"pp:endpoint": "images.product-upload", "pp:method": "POST", "pp:path": "/products/{id}/images", "pp:requires-input": "true"},
