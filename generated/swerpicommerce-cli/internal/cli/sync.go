...
Exit codes & warnings:
  ...
  swerpicommerce-pp-cli sync --resources channels,messages
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"site-specs-log":               "/site-specs/log",
		"swerpicommerce-agent-context": "/agent-context",
		...
		"vetrina-attributes":           "/vetrina/attributes",
