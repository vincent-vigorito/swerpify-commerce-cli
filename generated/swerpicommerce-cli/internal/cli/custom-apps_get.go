	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagIncludeContent != false {
				params["include_content"] = formatCLIParamValue(flagIncludeContent)
			}
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "custom-apps", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
