...
func newEmailListsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  swerpicommerce-pp-cli email-lists create --nome example-value",
		Annotations: map[string]string{"pp:endpoint": "email-lists.create", "pp:method": "POST", "pp:path": "/email-lists"},
