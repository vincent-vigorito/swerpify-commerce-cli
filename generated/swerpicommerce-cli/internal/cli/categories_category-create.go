...
func newCategoriesCategoryCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  swerpicommerce-pp-cli categories category-create --nome example-value",
		Annotations: map[string]string{"pp:endpoint": "categories.category-create", "pp:method": "POST", "pp:path": "/categories"},
	...
	cmd.Flags().StringVar(&bodyLang, "lang", "", "Codice lingua della categoria (es. it, en; default = lingua predefinita del sito). Nota: lo slug categoria è...")
