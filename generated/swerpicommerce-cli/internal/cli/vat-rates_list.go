...
func newVatRatesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Enumera le aliquote referenziate da `ProductInput.iva_id`.",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "vat-rates", path, retainCLIQueryParams(cmd, map[string]string{
