...
func newVetrinaAttributeValueCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Valore già presente -> 409 ATTRIBUTE_VALUE_EXISTS.",
		Annotations: map[string]string{"pp:endpoint": "vetrina.attribute-value-create", "pp:method": "POST", "pp:path": "/vetrina/attributes/{id}/values", "pp:requires-input": "true"},
