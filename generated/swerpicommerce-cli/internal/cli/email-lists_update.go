...
func newEmailListsUpdateCmd(flags *rootFlags) *cobra.Command {
	var bodyAttivo bool
	...
	cmd := &cobra.Command{
		Use:         "update <id>",
		Short:       "Aggiorna una lista email",
		Annotations: map[string]string{"pp:endpoint": "email-lists.update", "pp:method": "PUT", "pp:path": "/email-lists/{id}"},
