...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  swerpicommerce-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"article-categories", "articles", "articles-authors", "attributes", "automation-settings", "automations", "automations-lookups", "brands", "cache", "campaigns", "carts", "categories", "config", "config-autocommit", "custom-apps", "custom-apps-guide", "customer-tags", "customers", "design", "design-colors", "design-css", "design-logos", "design-swcss-guide", "design-templates", "design-templates-guide", "design-variables", "discount-codes", "email-lists", "email-notifications", "email-notifications-colors", "email-notifications-footer", "email-templates", "extra-tabs", "fonts", "fonts-assignments", "fork", "fork-diff", "fork-version", "forms", "forms-guide", "header-footer", "languages", "maintenance", "media", "orders", "page-templates", "pages", "payment-methods", "price-lists", "products", "quantity-discounts", "redirects", "review-requests", "reviews", "shipping-methods", "site-info", "site-specs", "site-specs-log", "swerpicommerce-agent-context", "swerpicommerce-auth", "swerpicommerce-auth-tokens", "update", "vat-groups", "vat-rates", "vat-rules", "vetrina", "vetrina-attributes", "vetrina-categories", "webhooks", "well-known"}
			totalSynced := 0
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/swerpicommerce-pp-cli/data.db)")
