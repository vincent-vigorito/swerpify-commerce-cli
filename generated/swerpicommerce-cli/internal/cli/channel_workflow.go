...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  swerpicommerce-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"article-categories", "articles", "attributes", "cache", "campaigns", "carts", "categories", "config", "customers", "design", "design-colors", "design-css", "design-swcss-guide", "design-templates", "design-templates-guide", "design-variables", "discount-codes", "email-lists", "email-templates", "fonts", "fonts-assignments", "fork", "forms", "forms-guide", "header-footer", "media", "orders", "page-templates", "pages", "payment-methods", "products", "shipping-methods", "swerpicommerce-auth", "swerpicommerce-auth-tokens", "update"}
			totalSynced := 0
