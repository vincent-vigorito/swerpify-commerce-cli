...
func newVetrinaProductDeleteCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "product-delete <id>",
		Short:       "Elimina record, varianti e riferimenti alle immagini (i file restano in libreria, possono essere condivisi",
