...
func newLanguagesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Equivalente al pannello",
		Annotations: map[string]string{"pp:endpoint": "languages.create", "pp:method": "POST", "pp:path": "/languages", "pp:requires-input": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = bodyMap
				if cmd.Flags().Changed("ecommerce-attivo") {
					bodyMap["ecommerce_attivo"] = bodyEcommerceAttivo
				}
				if cmd.Flags().Changed("href") || bodyHref != "" {
					bodyMap["href"] = bodyHref
				}
				if cmd.Flags().Changed("nome") || bodyNome != "" {
					bodyMap["nome"] = bodyNome
				}
				if cmd.Flags().Changed("predefinita") {
					bodyMap["predefinita"] = bodyPredefinita
				}
				if cmd.Flags().Changed("simbolo") || bodySimbolo != "" {
					bodyMap["simbolo"] = bodySimbolo
				}
