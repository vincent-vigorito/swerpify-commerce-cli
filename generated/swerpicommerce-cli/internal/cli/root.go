...
Run 'swerpicommerce-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'swerpicommerce-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("swerpicommerce-pp-cli %s\n", version)
		},
	}
}
