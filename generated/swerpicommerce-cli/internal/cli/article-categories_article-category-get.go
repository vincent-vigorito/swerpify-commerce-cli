...
func newArticleCategoriesArticleCategoryGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"get"},
		Short:       "Dettaglio categoria articoli",
		Annotations: map[string]string{"pp:endpoint": "article-categories.article-category-get", "pp:method": "GET", "pp:path": "/article-categories/{id}", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagIncludeAlternates != false {
				params["include_alternates"] = formatCLIParamValue(flagIncludeAlternates)
			}
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "article-categories", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
