...
func RegisterTools(s *server.MCPServer) {
	...
	s.AddTool(
		mcplib.NewTool("attributes_list",
			mcplib.WithDescription("Definizioni di attributi e valori gestite dal pannello (es. Taglia: S/M/L). I `valori_attributi` di POST/PUT /products vengono **risolti contro questo registro** (match esatto case-sensitive su nome attributo e valore): coppie non presenti nel registro -> 400 VALIDATION_ERROR. Optional: lang, limit (default: 100), offset (default: 0). Returns array of AttributesListItem."),
